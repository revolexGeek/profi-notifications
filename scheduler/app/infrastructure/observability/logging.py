...
Одна JSON-строка на запись в stdout (warning/error — в stderr), порог по уровню.
Инжектируется в сценарий — в домен не импортируется.
"""
...
class JsonLogger:
    def __init__(self, service: str = "scheduler", level: str = "info") -> None:
